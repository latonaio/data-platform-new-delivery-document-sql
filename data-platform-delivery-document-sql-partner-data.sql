...
(
    ...
    CONSTRAINT `DataPlatformDeliveryDocumentPartnerData_fk` FOREIGN KEY (`DeliveryDocument`) REFERENCES `data_platform_orders_header_data` (`DeliveryDocument`),
    CONSTRAINT `DataPlatformDeliveryDocumentPartnerDataPartnerFunction_fk` FOREIGN KEY (`PartnerFunction`) REFERENCES `data_platform_partner_function_partner_function_data` (`PartnerFunction`),
    CONSTRAINT `DataPlatformDeliveryDocumentPartnerDataBusinessPartner_fk` FOREIGN KEY (`BusinessPartner`) REFERENCES `data_platform_business_partner_general_data` (`BusinessPartner`),
    CONSTRAINT `DataPlatformDeliveryDocumentPartnerDataCountry_fk` FOREIGN KEY (`Country`) REFERENCES `data_platform_country_country_data` (`Country`),
