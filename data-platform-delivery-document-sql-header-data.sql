...
(
    ...
    CONSTRAINT `DPFMDeliveryDocumentHeaderDataProductionOrder_fk` FOREIGN KEY (`ProductionOrder`, `ProductionOrderItem`) REFERENCES `data_platform_production_order_item_data` (`ProductionOrder`, `ProductionOrderItem`),
    CONSTRAINT `DPFMDeliveryDocumentHeaderDataOperations_fk` FOREIGN KEY (`Operations`, `OperationsItem`) REFERENCES `data_platform_production_operations_item_data` (`Operations`, `OperationsItem`),
    CONSTRAINT `DPFMDeliveryDocumentHeaderDataBillOfMaterial_fk` FOREIGN KEY (`BillOfMaterial`, `BillOfMaterialItem`) REFERENCES `data_platform_production_bill_of_material_item_data` (`BillOfMaterial`, `BillOfMaterialItem`),
    CONSTRAINT `DPFMDeliveryDocumentHeaderDataDeliverToPlantTimeZone_fk` FOREIGN KEY (`DeliverToPlant`) REFERENCES `data_platform_time_zone_time_zone_data` (`TimeZone`),
