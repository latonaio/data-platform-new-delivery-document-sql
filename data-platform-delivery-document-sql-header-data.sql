...
(
    ...
    CONSTRAINT `DataPlatformDeliveryDocumentHeaderDataProductionOrder_fk` FOREIGN KEY (`ProductionOrder`, `ProductionOrderItem`) REFERENCES `data_platform_production_order_item_data` (`ProductionOrder`, `ProductionOrderItem`),
    CONSTRAINT `DataPlatformDeliveryDocumentHeaderDataOperations_fk` FOREIGN KEY (`Operations`, `OperationsItem`) REFERENCES `data_platform_production_operations_item_data` (`Operations`, `OperationsItem`),
    CONSTRAINT `DataPlatformDeliveryDocumentHeaderDataBillOfMaterial_fk` FOREIGN KEY (`BillOfMaterial`, `BillOfMaterialItem`) REFERENCES `data_platform_production_bill_of_material_item_data` (`BillOfMaterial`, `BillOfMaterialItem`),
