...
(
    ...
    `PlannedGoodsIssueQuantity`                       float(15) DEFAULT NULL,
    `PlannedGoodsIssueQtyInBaseUnit`                  float(15) DEFAULT NULL,
    `PlannedGoodsReceiptQuantity`                     float(15) DEFAULT NULL,
    `PlannedGoodsReceiptQtyInBaseUnit`                float(15) DEFAULT NULL,
    ...
    CONSTRAINT `DataPlatformDeliveryDocumentItemDataBillOfMaterial_fk` FOREIGN KEY (`BillOfMaterial`) REFERENCES `data_platform_bill_of_material_header_data` (`BillOfMaterial`),
    CONSTRAINT `DataPlatformDeliveryDocumentItemDataBillOfMaterialItem_fk` FOREIGN KEY (`BillOfMaterial`, `BillOfMaterialItem`) REFERENCES `data_platform_bill_of_material_item_data` (`BillOfMaterial`, `BillOfMaterialItem`),
    ...
    CONSTRAINT `DataPlatformDeliveryDocumentItemDataInternalCapacityQuantityUnit_fk` FOREIGN KEY (`InternalCapacityQuantityUnit`) REFERENCES `data_platform_quantity_unit_quantity_unit` (`QuantityUnit`),
    ...
    CONSTRAINT `DataPlatformDeliveryDocumentItemDataInspectionPlan_fk` FOREIGN KEY (`InspectionPlan`) REFERENCES `data_platform_inspection_header_data` (`InspectionPlan`),
    CONSTRAINT `DataPlatformDeliveryDocumentItemDataInspectionPlant_fk` FOREIGN KEY (`InspectionPlant`) REFERENCES `data_platform_plant_general_data` (`Plant`),   
    ...
    CONSTRAINT `DataPlatformDeliveryDocumentItemDataProductionOrder_fk` FOREIGN KEY (`ProductionOrder`, `ProductionOrderItem`) REFERENCES `data_platform_production_order_item_data` (`ProductionOrder`, `ProductionOrderItem`),
    CONSTRAINT `DataPlatformDeliveryDocumentItemDataOperations_fk` FOREIGN KEY (`Operations`, `OperationsItem`) REFERENCES `data_platform_production_operations_item_data` (`Operations`, `OperationsItem`),
    CONSTRAINT `DataPlatformDeliveryDocumentItemDataBillOfMaterial_fk` FOREIGN KEY (`BillOfMaterial`, `BillOfMaterialItem`) REFERENCES `data_platform_production_bill_of_material_item_data` (`BillOfMaterial`, `BillOfMaterialItem`),
