...
(
    ...
    CONSTRAINT `DPFMDeliveryDocumentItemDataInspectionPlan_fk` FOREIGN KEY (`InspectionPlan`) REFERENCES `data_platform_inspection_header_data` (`InspectionPlan`),
    CONSTRAINT `DPFMDeliveryDocumentItemDataInspectionPlant_fk` FOREIGN KEY (`InspectionPlant`) REFERENCES `data_platform_plant_general_data` (`Plant`),   
...
--  CONSTRAINT `DPFMDeliveryDocumentItemDataTaxCode_fk` FOREIGN KEY (`TaxCode`) REFERENCES `data_platform_tax_code_tax_code_data` (`TaxCode`),
